...
public class EducationDAOImpl implements EducationDAO {
	...
	@Override
	public List<Education> findEducationByPagination(int pageNo, int pageSize,int userId) {
		Query query = entityManager.createQuery("From Education where userId=:userId");
	 ...
	 */
	@Override
	public Long findTotalNoOfRecords(int userId) {
		 Query query = entityManager.createQuery("SELECT count(*) FROM Education where userId=:userId");
		 query.setParameter("userId", userId);
